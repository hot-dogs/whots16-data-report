...
for the WHOTS-16 and WHOTS-17 cruises. Broadband mode for the OS75 provided
...
#91361 and #850 during WHOTS-16 and WHOTS-17 cruises respectively. The CTD was
...
used during WHOTS-16 and WHOTS-17 cruises respectively employed a high-quality
...
procedures. The oxygen data from WHOTS-17 were calibrated using calibration
coefficients obtained during the HOT-327 cruise conducted on 15-19 February
2021, before the WHOTS-17 cruise, which used the same oxygen sensors.
...
SN 70168 for WHOTS-16 and SN 73647 for WHOTS-17. International Association for
...
measurements were less than ± 0.001 for WHOTS-16 and -17 cruises
{numref}`table-11`.
...
2019, and it was used for WHOTS-16. The batch #71 was prepared on August 27,
2021, and it was used for WHOTS-17.

Samples from the WHOTS-16 were measured on October 28, 2019 and samples from
WHOTS-17 were measured on September 13, 2021. {numref}`table-11` shows the
...
eleven CTD casts conducted during WHOTS-16 while the thermosalinograph was
...
CTD casts conducted during WHOTS-17 while the thermosalinograph was running.
...
Station 50 (WHOTS-17), and two at Station 52 (WHOTS-16). The 4 dbar downcast
...
```{table} ADCP record times (UTC mm/dd/yy hh:mm:ss) for the Narrow Band 75 kHz ADCP during the WHOTS-16 cruise
:class: sd-m-auto
:align: center
:name: table-12
...
{cite}`Santiago-Mandujano2022`) during operations near the WHOTS-16 and
WHOTS-17 moorings. The broadband system only recorded good data in the upper
